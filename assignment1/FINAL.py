...
def add_ride():
    ...
    resp0 = requests.get('http://127.0.0.1:5000/api/v1/users')
    resp0 = resp0.json()
    # print "RESP0______________", type(resp0.json())
    # resp1 = c.post('/api/v1/users',json=para1,follow_redirects=True)
